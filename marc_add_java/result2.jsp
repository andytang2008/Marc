...
<h3>${requestScope["pAddField"]}</h3>
<h3>${requestScope["pAddFieldContent"]}</h3>
	-->
		  	<%
		...
		final String paddField=(String)request.getAttribute("pAddField");
		final String paddFieldContent=(String)request.getAttribute("pAddFieldContent");
		
		TT.cal(fileName,pfileName,paddField,paddFieldContent);
			...
			<br>
			<br>
			<a href="http://librarysysworld.com:8080/marc_add_java">Go back</a>
