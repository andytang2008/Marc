        ...
        <div id="result">
           <!-- <h3>${requestScope["message"]}</h3>
			...
			<h3></h3>-->
				...
				Input which field you would like to add: <input type="text"  name="pAddField" placeholder="Adding field">  <br>
				Input the field content: <input type="text"  name="pAddFieldContent" placeholder="The content of Added field">  <br>
