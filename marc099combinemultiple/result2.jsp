...
<h3>${requestScope["pSourcefield"]}</h3>
<h3>${requestScope["pTargetfield"]}</h3>-->
		...
		final String pSource=(String)request.getAttribute("pSourcefield");
		final String pTarget=(String)request.getAttribute("pTargetfield");
		
		TT.cal(fileName,pfileName,pSource,pTarget);
			...
			<br><br><a href="http://librarysysworld.com:8080/marc099combinemultiple_java">Go back</a>
