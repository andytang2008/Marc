         ...
         <!-- <h3>${requestScope["message"]}</h3>
		  ...
		  <h3>${requestScope["UPLOAD_DIRECTORY_real_name"]}</h3>
			...
			<h3></h3>-->
				...
				Input the source field(Repetable)you want to combine: <input type="text"  name="pSource" placeholder="Source field">  <br>
				Input the Target field: <input type="text"  name="pTarget" placeholder="Target field">  <br>
